...
//
// Families is declared as any (not string) because the Ollama wire format
// returns it as a JSON array (e.g. ["llama"]) while some Nova builds may
// return a string. Using any lets the client decode either form without
// crashing; callers can type-assert as needed.
